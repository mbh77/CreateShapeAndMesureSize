...
{
    internal class ThermalEllipse : IThermalEllipse
    {
        ...
        public ThermalEllipse(string key, double left, double top, double width, double height)
        {
            _key = key;
            _imageKey = "Unknown";
            _left = left;
        ...
        public ThermalEllipse(string key, string imageKey, double left, double top, double width, double height, string stroke)
        {
            _key = key;
            _imageKey = imageKey;
            _left = left;
